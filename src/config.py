# Configuration settings for the Finance Management Application
...
# Asset paths
ASSETS_DIR = 'icons'
WINDOW_ICON = 'icons/64x64.ico'    # ICO format for window title bar
APP_LOGO = 'icons/logo.png'        # PNG format for in-app display (64x64 or 128x128)
...
# Default data - Start with 0 balance for new users
DEFAULT_ACCOUNTS = [
...
SAVINGS_CONFIG = {
    'MIN_BALANCE': 100.00,  # Minimum balance required
    'MAX_MONTHLY_WITHDRAWALS': 6,  # Maximum withdrawals per month
    'WITHDRAWAL_WARNING_THRESHOLD': 4  # Show warning after this many withdrawals
} 