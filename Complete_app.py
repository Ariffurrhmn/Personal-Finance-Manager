...
class SavingGoalPopup(PopupWindow):
    ...
    def __init__(self, parent: tk.Tk, database: Database, user: User, on_success: Callable[[], None]):
    ...
    def submit(self):
        ...
        try:
            ...
            logger.error(f"Unexpected error in saving goal creation: {e}")
...
class BudgetPopup(PopupWindow):
    ...
    def __init__(self, parent: tk.Tk, database: Database, user: User, 
                 categories: List[Category], on_success: Callable[[], None]):
...
class MainApp:
    ...
    def add_charts_to_pdf(self, story, report_data, report_type):
        ...
        try:
            ...
            logger.error(f"Error adding charts to PDF: {e}")
    ...
    def get_category_total_spent(self, category_id: int) -> float:
    ...
    def show_goal_completion_celebration(self, goal: SavingGoal):
    ...
    def convert_to_normal_account(self, goal: SavingGoal, popup: tk.Toplevel):
    ...
    def delete_completed_goal(self, goal: SavingGoal, popup: tk.Toplevel):
    ...
    def add_saving_goal(self):
        ...
        try:
            ...
            logger.error(f"Unexpected error creating saving goal: {e}")
            messagebox.showerror("Error", f"Failed to create saving goal: {e}")
    ...
    def _create_account_activity_chart(self, parent_frame, report_data):
        ...
        try:
            ...
            logger.error(f"Error creating account activity chart: {e}")
            # Show error message
            error_label = tk.Label(chart_frame, text="Chart preview unavailable", 
                                  font=FONTS['LIST_ITEM'], fg=COLORS['GREY'], bg=COLORS['WHITE'])
            error_label.pack(pady=20)
...
class FinanceApp:
    ...
    def show_login_popup(self):
        ...
        try:
            logger.info("Showing login popup")
            ...
            # Set window icon
            try:
                self.login_window.iconbitmap(WINDOW_ICON)
            except Exception as e:
            ...
            logger.error(f"Error showing login popup: {e}")
    ...
    def show_register_popup(self):
        ...
        try:
            logger.info("Showing register popup")
            ...
            logger.error(f"Error showing register popup: {e}")
    ...
    def show_login_popup_content(self):
        ...
        try:
            logger.info("Showing login content")
            ...
            logger.error(f"Error showing login content: {e}")
            messagebox.showerror("Error", f"Failed to show login screen: {e}")
    ...
    def create_main_window(self):
        ...
        try:
            ...
            # Set window icon
            try:
                self.main_root.iconbitmap(WINDOW_ICON)
            except Exception as e:
                logger.warning(f"Could not load window icon: {e}")
    ...
    def on_login_closing(self):
        ...
        try:
            ...
            logger.error(f"Error during login window closing: {e}")
        finally:
            sys.exit(0)
